...
namespace BrightChain.EntityFrameworkCore.Storage.Internal
{
    ...
    public class BrightChainDatabaseCreator : IDatabaseCreator
    {
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        public BrightChainDatabaseCreator(IDatabase database)
        {
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        protected virtual IBrightChainDatabase Database
            => (IBrightChainDatabase)this._database;
        ...
        public virtual bool EnsureCreated()
            => this.Database.EnsureDatabaseCreated();
        ...
        public virtual Task<bool> EnsureCreatedAsync(CancellationToken cancellationToken = default)
            => Task.FromResult(this.Database.EnsureDatabaseCreated());
