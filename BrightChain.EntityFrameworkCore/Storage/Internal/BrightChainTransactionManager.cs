...
namespace BrightChain.EntityFrameworkCore.Storage.Internal
{
    ...
    ///     </para>
    /// </summary>
    public class BrightChainTransactionManager : IDbContextTransactionManager, ITransactionEnlistmentManager
    {
        private static readonly BrightChainTransaction _stubTransaction = new();
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        public BrightChainTransactionManager(
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        public virtual void EnlistTransaction(Transaction? transaction) => this._logger.TransactionIgnoredWarning();
