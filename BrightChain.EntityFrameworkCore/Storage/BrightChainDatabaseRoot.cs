...
namespace BrightChain.EntityFrameworkCore.Storage
{
    /// <summary>
    ...
    ///     <see
    ///         cref="BrightChainDbContextOptionsExtensions.UseBrightChainDatabase{TContext}(DbContextOptionsBuilder{TContext},string,System.Action{BrightChainDbContextOptionsBuilder})" />
    /// </summary>
    public sealed class BrightChainDatabaseRoot
    {
        /// <summary>
        ///     <para>
