...
namespace BrightChain.EntityFrameworkCore.ValueGeneration.Internal
{
    ...
    /// </summary>
    public class BrightChainIntegerValueGenerator<TValue> : ValueGenerator<TValue>, IBrightChainIntegerValueGenerator
    {
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        public BrightChainIntegerValueGenerator(int propertyIndex) => this._propertyIndex = propertyIndex;
