...
{
    public class NorthwindAggregateOperatorsQueryBrightChainTest : NorthwindAggregateOperatorsQueryTestBase<
        NorthwindQueryBrightChainFixture<NoopModelCustomizer>>
    {
        public NorthwindAggregateOperatorsQueryBrightChainTest(
