...
{
    public class NorthwindMiscellaneousQueryBrightChainTest : NorthwindMiscellaneousQueryTestBase<
        NorthwindQueryBrightChainFixture<NoopModelCustomizer>>
    {
        public NorthwindMiscellaneousQueryBrightChainTest(
        ...
        {
            await this.AssertQuery(async, ss => ss.Set<Customer>(), entryCount: 91);
