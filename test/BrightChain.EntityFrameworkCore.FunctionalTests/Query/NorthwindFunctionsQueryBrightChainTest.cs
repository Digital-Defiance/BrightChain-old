...
{
    public class NorthwindFunctionsQueryBrightChainTest : NorthwindFunctionsQueryTestBase<NorthwindQueryBrightChainFixture<NoopModelCustomizer>>
    {
        public NorthwindFunctionsQueryBrightChainTest(
