...
{
    public class InheritanceQueryBrightChainTest : InheritanceQueryTestBase<InheritanceQueryBrightChainFixture>
    {
        public InheritanceQueryBrightChainTest(InheritanceQueryBrightChainFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
            this.ClearLog();
