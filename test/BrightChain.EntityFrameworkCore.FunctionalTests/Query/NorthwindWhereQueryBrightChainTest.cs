...
{
    public class NorthwindWhereQueryBrightChainTest : NorthwindWhereQueryTestBase<NorthwindQueryBrightChainFixture<NoopModelCustomizer>>
    {
        public NorthwindWhereQueryBrightChainTest(
