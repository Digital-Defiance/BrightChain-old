...
{
    public class NorthwindSelectQueryBrightChainTest : NorthwindSelectQueryTestBase<NorthwindQueryBrightChainFixture<NoopModelCustomizer>>
    {
        public NorthwindSelectQueryBrightChainTest(
...
ORDER BY c[""CustomerID""]");
        ...
        public override Task Reverse_without_explicit_ordering(bool async)
        {
            return AssertTranslationFailedWithDetails(
                () => base.Reverse_without_explicit_ordering(async), BrightChainStrings.MissingOrderingInSelectExpression);
        }
...
OFFSET 0 LIMIT @__p_0");
        ...
        public override async Task Projection_skip_projection_doesnt_project_intermittent_column(bool async)
        {
            ...
            Assert.Equal(BrightChainStrings.OffsetRequiresLimit, message);
        }
