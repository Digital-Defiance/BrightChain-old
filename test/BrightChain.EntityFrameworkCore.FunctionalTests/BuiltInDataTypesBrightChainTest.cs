...
{
    public class BuiltInDataTypesBrightChainTest : BuiltInDataTypesTestBase<BuiltInDataTypesBrightChainTest.BuiltInDataTypesBrightChainFixture>
    {
        public BuiltInDataTypesBrightChainTest(BuiltInDataTypesBrightChainFixture fixture)
            : base(fixture)
        {
        }
...
WHERE ((c[""Discriminator""] = ""BuiltInDataTypes"") AND (c[""Id""] = 13))");
        ...
        public class BuiltInDataTypesBrightChainFixture : BuiltInDataTypesFixtureBase
        {
