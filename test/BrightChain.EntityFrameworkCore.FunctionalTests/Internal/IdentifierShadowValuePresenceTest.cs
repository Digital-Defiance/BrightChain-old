...
namespace BrightChain.EntityFrameworkCore.Internal
{
    public class IdentifierShadowValuePresenceTest
    {
        ...
        {
            await using var testDatabase = BrightChainTestStore.Create("IdentifierShadowValuePresenceTest");
    ...
    public class IdentifierShadowValuePresenceTestContext : DbContext
    {
        ...
        public IdentifierShadowValuePresenceTestContext(BrightChainTestStore testStore)
        {
