...
namespace BrightChain.EntityFrameworkCore.Metadata
{
    public class BrightChainBuilderExtensionsTest
    {
        [ConditionalFact]
        ...
        {
            return BrightChainTestHelpers.Instance.CreateConventionBuilder();
        }
