...
namespace BrightChain.EntityFrameworkCore.Query.Internal
{
    ...
    ///     </para>
    /// </summary>
    public class BrightChainQueryTranslationPostprocessorFactory : IQueryTranslationPostprocessorFactory
    {
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        public BrightChainQueryTranslationPostprocessorFactory(
