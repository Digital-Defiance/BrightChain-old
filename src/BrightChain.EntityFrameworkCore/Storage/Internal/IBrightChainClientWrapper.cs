...
namespace BrightChain.EntityFrameworkCore.Storage.Internal
{
    ...
    /// </summary>
    public interface IBrightChainClientWrapper
    {
        /// <summary>
        ///     This is an internal API that supports the Entity Framework Core infrastructure and not subject to
        ///     the same compatibility standards as public APIs. It may be changed or removed without notice in
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        bool CreateItem(string containerId, JsonNode document, IUpdateEntry entry);
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        Task<JsonNode> ExecuteReadItemAsync(
            string containerId,
            string? partitionKey,
            string resourceId,
            CancellationToken cancellationToken = default);
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        IEnumerable<JsonNode> ExecuteSqlQuery(
            string containerId,
            string? partitionKey,
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        IAsyncEnumerable<JsonNode> ExecuteSqlQueryAsync(
            string containerId,
            string? partitionKey,
            BrightChainSqlQuery query);
    }
