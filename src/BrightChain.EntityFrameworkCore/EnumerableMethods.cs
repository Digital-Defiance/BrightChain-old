...
namespace BrightChain.EntityFrameworkCore
{
    internal static class EnumerableMethods
    {
        ...
        {
            return MaxWithoutSelectorMethods.TryGetValue(type, out var method)
                           ? method
                           : MaxWithoutSelector;
        }
        ...
        {
            return MaxWithSelectorMethods.TryGetValue(type, out var method)
                           ? method
                           : MaxWithSelector;
        }
        ...
        {
            return MinWithoutSelectorMethods.TryGetValue(type, out var method)
                           ? method
                           : MinWithoutSelector;
        }
        ...
        {
            return MinWithSelectorMethods.TryGetValue(type, out var method)
                           ? method
                           : MinWithSelector;
        }
