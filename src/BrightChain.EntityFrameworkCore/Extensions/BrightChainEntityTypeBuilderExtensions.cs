...
{
    /// <summary>
    ///     BrightChain-specific extension methods for <see cref="EntityTypeBuilder" />.
    /// </summary>
    public static class BrightChainEntityTypeBuilderExtensions
    {
        /// <summary>
        ///     Configures the container that the entity type maps to when targeting Azure BrightChain.
        /// </summary>
        ...
        public static EntityTypeBuilder<TEntity> ToContainer<TEntity>(
            ...
            where TEntity : class
        {
            return (EntityTypeBuilder<TEntity>)ToContainer((EntityTypeBuilder)entityTypeBuilder, name);
        }
            ...
            bool fromDataAnnotation = false)
        {
            ...
            return entityTypeBuilder.CanSetAnnotation(BrightChainAnnotationNames.ContainerName, name, fromDataAnnotation);
        }
            ...
            bool fromDataAnnotation = false)
        {
            ...
            return entityTypeBuilder.CanSetAnnotation(BrightChainAnnotationNames.PropertyName, name, fromDataAnnotation);
        }
            ...
            bool fromDataAnnotation = false)
        {
            ...
            return entityTypeBuilder.CanSetAnnotation(BrightChainAnnotationNames.PartitionKeyName, name, fromDataAnnotation);
        }

        /// <summary>
        ///     Configures this entity to use BrightChainDb etag concurrency checks.
        /// </summary>
        /// <param name="entityTypeBuilder"> The builder for the entity type being configured. </param>
        /// <returns> The same builder instance so that multiple calls can be chained. </returns>
