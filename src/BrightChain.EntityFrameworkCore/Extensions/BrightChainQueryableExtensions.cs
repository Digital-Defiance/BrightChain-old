...
{
    /// <summary>
    ///     BrightChain DB specific extension methods for LINQ queries.
    /// </summary>
    public static class BrightChainQueryableExtensions
    {
        internal static readonly MethodInfo WithPartitionKeyMethodInfo
            = typeof(BrightChainQueryableExtensions).GetRequiredDeclaredMethod(nameof(WithPartitionKey));
