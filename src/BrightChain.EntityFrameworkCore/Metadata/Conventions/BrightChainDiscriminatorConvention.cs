...
namespace BrightChain.EntityFrameworkCore.Metadata.Conventions
{
    ...
    /// </summary>
    public class BrightChainDiscriminatorConvention :
    ...
    {
        /// <summary>
        ///     Creates a new instance of <see cref="BrightChainDiscriminatorConvention" />.
        /// </summary>
        /// <param name="dependencies"> Parameter object containing dependencies for this convention. </param>
        public BrightChainDiscriminatorConvention(ProviderConventionSetBuilderDependencies dependencies)
            : base(dependencies)
        {
        }
