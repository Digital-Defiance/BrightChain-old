...
namespace BrightChain.EntityFrameworkCore.Properties
{
    ...
    /// </summary>
    public static class BrightChainStrings
    {
        private static readonly ResourceManager _resourceManager
            = new ResourceManager("BrightChain.EntityFrameworkCore.Properties.BrightChainStrings", typeof(BrightChainStrings).Assembly);

        /// <summary>
        ///     The BrightChain database does not support 'CanConnect' or 'CanConnectAsync'.
        /// </summary>
        ...
        /// <summary>
        ///     BrightChain-specific methods can only be used when the context is using the BrightChain provider.
        /// </summary>
        public static string BrightChainNotInUse
            => GetString("BrightChainNotInUse");
        ...
        /// <summary>
        ///     BrightChain SQL does not allow Offset without Limit. Consider specifying a 'Take' operation on the query.
        /// </summary>
        ...
        /// <summary>
        ///     The BrightChain database provider does not support transactions.
        /// </summary>
...
namespace BrightChain.EntityFrameworkCore.Internal
{
    ...
    {
        private static readonly ResourceManager _resourceManager
            = new ResourceManager("BrightChain.EntityFrameworkCore.Properties.BrightChainStrings", typeof(BrightChainResources).Assembly);
        ...
        {
            var definition = ((Diagnostics.Internal.BrightChainLoggingDefinitions)logger.Definitions).LogExecutingReadItem;
            if (definition == null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.BrightChainLoggingDefinitions)logger.Definitions).LogExecutingReadItem,
                    logger,
                    static logger => new EventDefinition<string, string, string?>(
                        logger.Options,
                        BrightChainEventId.ExecutingReadItem,
        ...
        {
            var definition = ((Diagnostics.Internal.BrightChainLoggingDefinitions)logger.Definitions).LogExecutingSqlQuery;
            if (definition == null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.BrightChainLoggingDefinitions)logger.Definitions).LogExecutingSqlQuery,
                    logger,
                    static logger => new EventDefinition<string, string?, string, string, string>(
                        logger.Options,
                        BrightChainEventId.ExecutingSqlQuery,
                        LogLevel.Information,
                        "BrightChainEventId.ExecutingSqlQuery",
