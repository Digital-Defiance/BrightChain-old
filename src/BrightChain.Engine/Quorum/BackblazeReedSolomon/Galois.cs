...
public sealed class Galois
{
    ...
    public static byte divide(int a, int b)
    {
        if (a == 0)
        {
            return 0;
    ...
    public static short[] generateLogTable(byte polynomial)
    {
    ...
    /// <returns></returns>
    public static int[] generateExpTable(short[] logTable)
    {
        var result = new int [(FIELD_SIZE * 2) - 2];
    ...
    /// </summary>
    public static byte[] allPossiblePolynomials()
    {
