...
public static class BlockSizeMap
{
    ...
    public static readonly ImmutableDictionary<BlockSize, BlockHash> ZeroVectorMap = new Dictionary<BlockSize, BlockHash>
    {
        ...
        {
            Enumerations.BlockSize.Nano, new BlockHash(
                blockType: typeof(ZeroVectorBlock),
                originalBlockSize: Enumerations.BlockSize.Nano,
                providedHashBytes: Convert.FromHexString(s: "38723a2e5e8a17aa7950dc008209944e898f69a7bd10a23c839d341e935fd5ca"),
                computed: true)
        },
        {
            Enumerations.BlockSize.Micro, new BlockHash(
                blockType: typeof(ZeroVectorBlock),
                originalBlockSize: Enumerations.BlockSize.Micro,
                providedHashBytes: Convert.FromHexString(s: "5341e6b2646979a70e57653007a1f310169421ec9bdd9f1a5648f75ade005af1"),
                computed: true)
        },
        {
            Enumerations.BlockSize.Tiny, new BlockHash(
                blockType: typeof(ZeroVectorBlock),
                originalBlockSize: Enumerations.BlockSize.Tiny,
                providedHashBytes: Convert.FromHexString(s: "5f70bf18a086007016e948b04aed3b82103a36bea41755b6cddfaf10ace3c6ef"),
                computed: true)
        },
        {
            Enumerations.BlockSize.Small, new BlockHash(
                blockType: typeof(ZeroVectorBlock),
                originalBlockSize: Enumerations.BlockSize.Small,
                providedHashBytes: Convert.FromHexString(s: "ad7facb2586fc6e966c004d7d1d16b024f5805ff7cb47c7a85dabd8b48892ca7"),
                computed: true)
        },
        {
            Enumerations.BlockSize.Message, new BlockHash(
                blockType: typeof(ZeroVectorBlock),
                originalBlockSize: Enumerations.BlockSize.Message,
                providedHashBytes: Convert.FromHexString(s: "076a27c79e5ace2a3d47f9dd2e83e4ff6ea8872b3c2218f66c92b89b55f36560"),
                computed: true)
        },
        {
            Enumerations.BlockSize.Medium, new BlockHash(
                blockType: typeof(ZeroVectorBlock),
                originalBlockSize: Enumerations.BlockSize.Medium,
                providedHashBytes: Convert.FromHexString(s: "30e14955ebf1352266dc2ff8067e68104607e750abb9d3b36582b8af909fcb58"),
                computed: true)
        },
        {
            Enumerations.BlockSize.Large, new BlockHash(
                blockType: typeof(ZeroVectorBlock),
                originalBlockSize: Enumerations.BlockSize.Large,
                providedHashBytes: Convert.FromHexString(s: "bb9f8df61474d25e71fa00722318cd387396ca1736605e1248821cc0de3d3af8"),
                computed: true)
        },
    }.ToImmutableDictionary();
    ...
    {
        if (!Map.ContainsKey(key: blockSize))
        {
            throw new KeyNotFoundException(message: nameof(blockSize));
        }

        return Map[key: blockSize];
    }
    ...
    {
        if (!HashesPerBlockMap.ContainsKey(key: blockSize))
        {
            throw new KeyNotFoundException(message: nameof(blockSize));
        }

        var value = HashesPerBlockMap[key: blockSize];
        if (exponent <= 1)
        {
            return value;
        }

        return (long)Math.Pow(x: value,
            y: exponent);
    }
    ...
    public static BlockHash ZeroVectorHash(BlockSize blockSize)
    {
        ...
        var b = ZeroVectorMap.TryGetValue(key: blockSize,
            value: out expectedVector);
        if (!b)
        {
            throw new BrightChainException(message: nameof(blockSize));
        }
    ...
    {
        return new ZeroVectorBlock(blockSize: blockSize);
    }
}
