...
/// </summary>
[ProtoContract]
public class BrightenedBlock : Block, IDisposable, ITransactable, ITransactableBlock, IComparable<BrightenedBlock>,
    IComparable<ITransactableBlock>, IEquatable<IBlock>
{
    /// <summary>
    ...
    public BrightenedBlock(BrightenedBlockParams blockParams, ReadOnlyMemory<byte> data,
        IEnumerable<BlockHash> constituentBlockHashes = null)
        : base(
    ...
    public override BrightenedBlockParams BlockParams => new(
        ...
        blockParams: new BlockParams(
            ...
            originalType: Type.GetType(typeName: this.OriginalAssemblyTypeString)));
    ...
    {
        return a.BlockSize == b.BlockSize && a.StoredData.Equals(other: b.StoredData);
    }
    ...
    {
        return obj is BrightenedBlock blockObj ? this.StoredData.Equals(other: blockObj.StoredData) : false;
    }
