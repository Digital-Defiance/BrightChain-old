...
namespace BrightChain.Models.Blocks
{
    ...
    public class BrokeredAnonymityIdentifier : IComparable<BrokeredAnonymityIdentifier>, IDisposable, IFormattable, IEquatable<BrokeredAnonymityIdentifier>
    {
        ...
        public int CompareTo(BrokeredAnonymityIdentifier other) => throw new NotImplementedException();
        public void Dispose() => throw new NotImplementedException();
        public bool Equals(BrokeredAnonymityIdentifier other) => throw new NotImplementedException();
